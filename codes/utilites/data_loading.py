...
DATADIR = 'https://raw.githubusercontent.com/Skanda-Aithal/Wcup/main'
groups = pd.read_csv('C:/Users/skand/Desktop/ll/FIFA-World-Cup-2018-Visualization-and-Prediction-main/data/csv/Groups.csv',parse_dates=[0])
img = DATADIR + '/data/images/TeamLogos/' #Team logos' directory

competitions = sb.competitions() #Get competitions from Statsbomb 
matches = sb.matches(competition_id=43, season_id=106) #Get world cup matches from Statsbomb
